...
class Experiment(object):
    ...
    def create_videos(self, divisions=5, folder="./", fps=1,
        ...
        self.create_density_video(divisions, folder, fps, number_of_bursts, x_free)
        self.create_relative_g2_video(divisions, folder, fps, number_of_bursts, x_free)
        self.create_relative_g4_video(divisions, folder, fps, number_of_bursts, x_free)

...
experiment_5.create_gifs(divisions=10, fps=3, max_distance=10, max_angle_diff=5)
experiment_17.create_gifs(divisions=10, fps=3, max_distance=10, max_angle_diff=5)
